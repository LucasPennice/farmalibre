...
-- USUARIOS
-- =========================
INSERT INTO usuario (nombre_completo_responsable, nombreUsuario, passEncriptada, direccion, rol, onboarding_completo, email) VALUES
('Administrador General', 'admin', 'admin123', 'Oficina Central', 'ADMIN', FALSE, "fake@gmail.com"),
('María González', 'maria', 'maria123', 'Av. Siempre Viva 742', 'USUARIO', FALSE, "fake@gmail.com"),
('Carlos López', 'carlos', 'carlos123', 'Calle Falsa 123', 'USUARIO', FALSE, "fake@gmail.com");
