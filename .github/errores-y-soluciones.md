...
Error al popular la base de datos / Error al inicializar la base de datos "No conoce farmacia_db".

1 - Drop base de datos y base de datos testing ("drop database farmacia_db" "drop database farmacia_test")
2 - Crear la base de datos y el esquema (mysql -u root -p < src/main/resources/schema.sql)
3 - Popular la base de datos (mysql -u root -p < src/main/resources/seed.sql)
